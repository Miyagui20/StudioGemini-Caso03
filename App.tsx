    ...
    return (
      <div key={index} className="bg-white border border-slate-100 rounded-[2rem] p-6 md:p-10 shadow-sm text-slate-700 mb-8 last:mb-0">
        ...
        <div className="pt-4 border-t border-slate-50 flex items-center gap-2 text-[10px] md:text-xs font-medium text-slate-400 italic">
          <svg className="w-3 h-3 md:w-3.5 md:h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.803a4 4 0 015.656 0l4 4a4 4 0 11-5.656 5.656l-1.1-1.1" /></svg>
          {source}
        </div>
      </div>
    );
